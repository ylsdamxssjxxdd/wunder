...
## 示例与模板
- 示例流程图：`{{SKILL_ROOT}}/examples/sample-diagram.svg`
- 示例图表：`{{SKILL_ROOT}}/examples/sample-chart.svg`
- 脚本模板：`{{SKILL_ROOT}}/scripts/svg_starter.py`
...
## 脚本模板用法
```bash
python {{SKILL_ROOT}}/scripts/svg_starter.py --output out.svg --title "技术文档标准化流程" --steps "采集" "加工" "发布"
```
