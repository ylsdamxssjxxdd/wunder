...
Xinjian is a desktop agent that can **fully take over your computer (with your permission)** and do office work for you. We now focus on **wunder-desktop** - download, install, and use.
It is not just chat. You state the goal, it breaks down tasks automatically, calls tools, and delivers results. When needed, it also supports **multi-agent parallel collaboration**, where different agents work on different parts at the same time.

## Capability Snapshot (based on real Xinjian features)
...
- Search and synthesize information, extract key points, write meeting notes
- Write code, refactor, generate scripts, and build automation flows
- Combine MCP + Skills to build your own workflows
- **Build wunder itself (bootstrap)** - let wunder write code, update docs, and run tasks

## Quick Start (3 steps)
1. Open the Releases page and download the wunder-desktop package for your system (follow the release page as source of truth).
...
| `wunder-cli` | Developers / automation | Command-line driven tasks and scripted execution |
...
A: No. wunder-desktop is the recommended entry. You can use it immediately after download. Consider server only if you need team collaboration or deeper integrations.

**Q: Do I need technical skills?**  
A: No. It is designed for everyday users - just state your goal and the agent handles the rest.

**Q: How do I use multi-agent mode?**  
A: Just describe your objective. The system can split work automatically in parallel, and you can also explicitly ask it to "run in parallel".
