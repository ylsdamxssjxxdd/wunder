...
pub use services::{
    ...
    knowledge, llm, mcp, memory, org_units, prompting, sim_lab, skills, swarm, tools,
    user_access, user_presence, user_prompt_templates, user_store, user_tools, user_world,
