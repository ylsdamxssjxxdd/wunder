...
pub const CHANNEL_CATALOG: &[ChannelCatalogItem] = &[
    ...
    ChannelCatalogItem {
        channel: "weixin",
        display_name: "Weixin iLink (New)",
        description: "Weixin iLink long-poll channel runtime adapter",
        user_supported: true,
        webhook_mode: "runtime+generic",
        docs_hint: "/docs/方案/新微信渠道落地方案.md",
    },
    ChannelCatalogItem {
        channel: "wechat",
        display_name: "WeCom (Legacy)",
        description: "Legacy Enterprise WeChat callback and outbound adapter",
        user_supported: true,
        webhook_mode: "specialized+generic",
    ...
    ChannelCatalogItem {
        channel: "wechat_mp",
        display_name: "WeChat MP (Legacy)",
        description: "Legacy WeChat Official Account callback and outbound adapter",
        user_supported: true,
        webhook_mode: "specialized+generic",
