...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'orchestration', name: 'desktop-orchestration', component: MessengerView },
      { path: 'plaza', name: 'desktop-plaza', component: MessengerView },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'orchestration', name: 'orchestration', component: MessengerView },
      { path: 'plaza', name: 'plaza', component: MessengerView },
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'orchestration', name: 'demo-orchestration', component: MessengerView, meta: { demo: true } },
      { path: 'plaza', name: 'demo-plaza', component: MessengerView, meta: { demo: true } },
