      ...
      <section class="portal-main">
        <div class="portal-main-scroll">
            ...
            <div class="tool-catalog-grid">
              ...
              >
                <div class="tool-catalog-header">
                  ...
                  <span class="tool-catalog-level">等级 {{ group.level }}</span>
                </div>
          ...
          <section class="portal-section">
            <div class="portal-section-header">
              <div>
                <div class="portal-section-title">额外提示词</div>
                <div class="portal-section-desc">为所有智能体追加你的默认规则</div>
              </div>
            </div>
            <div class="user-tools-dialog user-tools-page">
              <UserExtraPromptPanel />
            </div>
          </section>
        </div>
      </section>
...
import UserExtraPromptPanel from '@/components/user-tools/UserExtraPromptPanel.vue';
