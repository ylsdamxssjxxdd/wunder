...
:global(.feature-window-dialog--cron.el-dialog) {
  ...
  --fw-control-hover: var(--ui-accent-soft);
  --fw-focus-border: rgba(var(--ui-accent-rgb), 0.45);
  --fw-focus-ring: rgba(var(--ui-accent-rgb), 0.14);
  --fw-accent-border: rgba(var(--ui-accent-rgb), 0.42);
  --fw-accent-shadow: rgba(var(--ui-accent-rgb), 0.18);
  --fw-danger: #c14053;
