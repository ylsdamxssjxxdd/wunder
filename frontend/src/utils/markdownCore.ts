...
} from '@/utils/workspaceResourceMetadata';
...
// Rendering is synchronous; each request supplies its own locale-dependent labels.
let renderLabels: Record<string, string> = {};
const t = (key: string) => renderLabels[key] || key;
