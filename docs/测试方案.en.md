...
```
docker run --rm -i -e WUNDER_API_KEY=your-key -v "${PWD}:/work" -w /work grafana/k6 run -e WUNDER_PROFILE=load -e WUNDER_BASE_URL=http://192.168.0.2:18000/wunder tests/performance/k6_wunder.js
```

### 4.3 Optional parameters (env vars)
- `WUNDER_PROFILE`: load profile, `quick/load/spike/soak`, default `load`
- `WUNDER_BASE_URL`: default `http://127.0.0.1:18000/wunder`
...
Example:
```
$env:WUNDER_API_KEY="your-key"; $env:WUNDER_BASE_URL="http://127.0.0.1:18000/wunder"; $env:WUNDER_PROFILE="load"; k6 run tests/performance/k6_wunder.js
```
