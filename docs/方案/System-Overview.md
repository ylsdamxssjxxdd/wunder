...
With `sandbox.mode=sandbox`, built-in tools like command execution run via the shared sandbox service (`WUNDER_SANDBOX_ENDPOINT`); for docker compose deployments, prefer internal DNS `http://wunder-sandbox:9001` and do not publish port 9001.
...
---
For deeper technical details, see: `docs/方案/Design-Plan.md` and `docs/方案/API-Documentation.md`.
