...
- 先关心“文件和代码怎么读写”，直接看 [工作区文件](/docs/zh-CN/tools/workspace-files/)
- 先关心“子智能体和蜂群怎么协作”，直接看 [子智能体控制](/docs/zh-CN/tools/subagent-control/) 和 [智能体蜂群](/docs/zh-CN/tools/agent-swarm/)
- 先关心“当前某个工具具体返回什么”，跳到对应单工具页，那里已经按最新实现列出成功返回结构
