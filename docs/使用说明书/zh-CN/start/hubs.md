---
title: 说明书总览
summary: 按角色和任务快速定位使用说明书入口，避免在全站里盲搜。
read_when:
  - 你不确定先看哪一页
  - 你希望按角色快速进入正确文档路径
source_docs:
...
- [常用说明目录](/docs/zh-CN/start/docs-directory/)
