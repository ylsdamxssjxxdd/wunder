...
- Docker compose supports a single-entry deployment: keep `18001` as the only public port, proxy `/wunder` routes through the frontend to internal `wunder_server:18000`, and bind data services to localhost only.
