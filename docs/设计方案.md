...
补充说明：
- `channels` 为多渠道接入配置，支持 webhook 接入、绑定路由、出站重试与多模态处理，默认关闭。
...
- 多渠道数据：channel_accounts/channel_bindings/channel_sessions/channel_messages/channel_outbox/media_assets/speech_jobs（可选）统一入库。
