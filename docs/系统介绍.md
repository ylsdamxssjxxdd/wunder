...
## 8. 运维与管理入口
- 用户侧前端（Vue3）：默认 18001 端口，目录 `frontend/`，通过 `/wunder/auth`、`/wunder/chat`、`/wunder/workspace` 与 `/wunder/user_tools` 调用后端。
...
- `/wunder/doc2md/convert`：文档转 Markdown（无鉴权，multipart 上传）。
