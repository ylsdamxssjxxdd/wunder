...
pub(crate) fn status_for_error_code(code: &str) -> StatusCode {
    ...
    match normalized.as_str() {
        ...
        "RATE_LIMITED" | "USER_BUSY" | "USER_QUOTA_EXCEEDED" | "USER_QUOTA_INSUFFICIENT" => {
...
pub(crate) fn hint_for_error_code(code: &str) -> Option<&'static str> {
    ...
    match normalized.as_str() {
        ...
        "USER_BUSY" | "USER_QUOTA_EXCEEDED" | "USER_QUOTA_INSUFFICIENT" | "RATE_LIMITED" => {
...
mod tests {
    ...
    fn status_mapping_for_custom_error_code_is_stable() {
        assert_eq!(
            status_for_error_code("USER_QUOTA_INSUFFICIENT"),
            StatusCode::TOO_MANY_REQUESTS
        );
        assert_eq!(
